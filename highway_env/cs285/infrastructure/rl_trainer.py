...
class RL_Trainer(object):
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths, training_logs):
        ...
        eval_paths, eval_envsteps_this_batch = utils.sample_trajectories(self.env, eval_policy, self.params['eval_batch_size'], self.params['ep_len'], render=self.params['render'])
        ...
        if self.log_metrics:
            ...
            logs["num_agent_train_steps_per_iter"] = self.params["num_agent_train_steps_per_iter"]
