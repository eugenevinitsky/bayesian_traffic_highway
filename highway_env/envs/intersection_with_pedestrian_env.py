...
class PedestrianIntersectionEnv(IntersectionEnv):
    ...
    def _make_road(self) -> None:
        ...
        for corner in range(4):
            ...
            # Incoming
            lt = [c, c] if self.config["scenario"] in [9, 10] and corner == 0 else [s, c]
            ...
            # Right turn
            lt = [c, c] if self.config["scenario"] in [9, 10] and corner == 0 else [n, c]
    ...
    def _make_vehicles(self, n_vehicles: int = 10) -> None:
        ...
        if self.config["scenario"] is not None:
            ...
            if self.config["scenario"] == 0: # debug
                ...
                spawn_vehicle(lane=("o0", "ir0", 0), dest="o3", pos=78, speed=10.0, type="car")
                spawn_vehicle(lane=("p1_inv", "ir1", 0), dest="o1", pos=100, speed=2.0, type="ped")
            else:
