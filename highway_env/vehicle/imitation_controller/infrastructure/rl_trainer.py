...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        self.env.config["scenario"] = self.params['scenario']
        # to avoid constant inflow
        self.env.config["spawn_probability"] = 0
        # inference noise (std of normal noise added to inferred accelerations)
        self.env.config["inference_noise_std"] = self.params['inference_noise_std']
        # default behavior for cars is IDM
        self.env.config["other_vehicles_type"] = 'highway_env.vehicle.behavior.IDMVehicle'
        # observation type
        self.env.config["type"] = 'IntersectionWithPedObservation'
        # observation type
        self.env.config["observation"]["type"] = 'IntersectionWithPedObservation'
